...
instance Print Grammar.Abs.Arg where
  prt i e = case e of
    Grammar.Abs.ADecl type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id])
  prtList _ [] = concatD []
...
instance Print Grammar.Abs.Stm where
  prt i e = case e of
    Grammar.Abs.SDecl type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString ";")])
    ...
    Grammar.Abs.SIfElse exp stm1 stm2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 exp, doc (showString ")"), prt 0 stm1, doc (showString "else"), prt 0 stm2])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]
...
instance Print Grammar.Abs.Exp where
  prt i e = case e of
    ...
    Grammar.Abs.EString str -> prPrec i 15 (concatD [prt 0 str])
    ...
    Grammar.Abs.ECall id exps -> prPrec i 15 (concatD [prt 0 id, doc (showString "("), prt 0 exps, doc (showString ")")])
    ...
    Grammar.Abs.ELl exp1 exp2 -> prPrec i 10 (concatD [prt 10 exp1, doc (showString "<<"), prt 10 exp2])
    Grammar.Abs.EGg exp id -> prPrec i 10 (concatD [prt 10 exp, doc (showString ">>"), prt 0 id])
    Grammar.Abs.ELib id1 id2 -> prPrec i 10 (concatD [prt 0 id1, doc (showString "::"), prt 0 id2])
    Grammar.Abs.ETerm -> prPrec i 10 (concatD [doc (showString "\""), doc (showString "\"")])
  prtList _ [] = concatD []
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString ","), prt 0 xs]
